...
@blblub.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@blblub.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@blblub.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
