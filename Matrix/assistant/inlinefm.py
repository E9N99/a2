...
# BACK
@blblub.tgbot.on(CallbackQuery(pattern="fmback"))
@check_owner
...
# UP
@blblub.tgbot.on(CallbackQuery(pattern="fmup_(.*)"))
@check_owner
async def up(event):
...
# DOWN
@blblub.tgbot.on(CallbackQuery(pattern="fmdown_(.*)"))
@check_owner
...
# FORTH
@blblub.tgbot.on(CallbackQuery(pattern="fmforth_(.*)"))
@check_owner
...
# REMOVE
@blblub.tgbot.on(CallbackQuery(pattern="fmrem_(.*)"))
@check_owner
...
# SEND
@blblub.tgbot.on(CallbackQuery(pattern="fmsend"))
@check_owner
...
# CUT
@blblub.tgbot.on(CallbackQuery(pattern="fmcut_(.*)"))
@check_owner
async def cut(event):
...
# COPY
@blblub.tgbot.on(CallbackQuery(pattern="fmcopy_(.*)"))
@check_owner
...
# PASTE
@blblub.tgbot.on(CallbackQuery(pattern="fmpaste_(.*)"))
@check_owner
