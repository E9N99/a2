        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            ...
            if pattern is not None:
                ...
                if edited:
                    blblub.add_event_handler(func, events.MessageEdited(**kwargs))
                blblub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                blblub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                blblub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
